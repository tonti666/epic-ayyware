...
private:
	...
	void default_box2(IClientEntity* pEntity, Box size, Color color);
	void default_box3(IClientEntity* pEntity, Box size, Color color);
	void DrawBox(Box size, Color color);
	void flashbar();
	...
	void enemy_out_of_range(IClientEntity* entity);

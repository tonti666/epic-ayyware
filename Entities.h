...
public:
	...
	{
		short WeaponId = *this->GetItemDefinitionIndex();
		return WeaponId == WEAPON_M4A1 || WEAPON_M4A1_SILENCER || WEAPON_AK47 || WEAPON_GALILAR || WEAPON_REVOLVER ||WEAPON_FAMAS  || WEAPON_DEAGLE || WEAPON_ELITE || WEAPON_GLOCK || WEAPON_HKP2000 || WEAPON_USP_SILENCER || WEAPON_TEC9 || WEAPON_CZ75A || WEAPON_FIVESEVEN || WEAPON_P250;
	}
...
public:
	...
	Vector vecForce()
	{
		return *(Vector*)((DWORD)this + GET_NETVAR("DT_CSPlayer", "m_vecOrigin"));
	}
	Vector vecRagdollVelocity()
	{
		return *(Vector*)((DWORD)this + GET_NETVAR("DT_CSRagdoll", "m_vecRagdollVelocity"));
	}
...
//	CNETVAR_FUNC(int, team, "DT_BaseEntity", "m_iTeamNum");
	...
	{
		return *reinterpret_cast<float*>((DWORD)this + 0x3A74);
	}
	float &getPoseParams(int idx)
	{
		return *reinterpret_cast<float*>(reinterpret_cast<uintptr_t>(this) + 0x2774 + sizeof(float) * idx);
	}
	...
	matrix3x4_t GetBoneMatrix2(int BoneID)
	{
		matrix3x4_t matrix;
	...
	matrix3x4_t GetBoneMatrix3(int BoneID)
	{
		matrix3x4_t matrix;
	...
	*/
	...
	Vector GetEyePosition() {
		Vector Origin = *(Vector*)((DWORD)this + 0x00000138);
		Vector View = *(Vector*)((DWORD)this + 0x00000108);
		return(Origin + View);
	}
	Vector GetAimPunch() {

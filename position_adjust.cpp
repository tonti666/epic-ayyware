...
{
	if (options::menu.aimbot_tab.lag_pred.GetState() || options::menu.LegitBotTab.legitbacktrack.GetState())
	{
...
void BackTrack::legit_backtrack(CUserCmd * cmd, IClientEntity * pLocal)
{

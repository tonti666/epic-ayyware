...
public:
	...
	void legit(CUserCmd * cmd, bool moving, bool &bSendPacket);
...
//	bool swap_sides_move = Options::Menu.MiscTab.desync_swapsides_move.GetState();
	...
	float stand_range = options::menu.MiscTab.desync_range_stand.GetValue();
	float move_range = options::menu.MiscTab.desync_range_move.GetValue();
};
